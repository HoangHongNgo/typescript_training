...
export const ERROR_MESSAGE = {
  INIT_CONTACT_LIST: 'Could not initialize contact list',
  INIT_RELATION_LIST: 'Could not initialize relation list',
  RENDER_CONTACT_LIST: 'Could not display contact list',
  RENDER_CONTACT_INFO: 'Could not display contact info',
  GET_CONTACT_INFO: 'Could not get contact info',
  DELETE_CONTACT: 'Could not delete contact',
  ADD_CONTACT: 'Could not add contact',
  EDIT_CONTACT: 'Could not edit contact',
};
